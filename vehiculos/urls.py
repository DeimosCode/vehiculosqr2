...
from .views import registrar_vehiculo, consultar_vehiculo, login_view, register_view, home_view, logout_view, registrar_observacion
...
urlpatterns = [
    ...
    path('vehiculo/<str:codigo>/observacion/', views.registrar_observacion, name='registrar_observacion'),
